        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="border rounded-3 my-2 p-3">
                    ...
                    <p>Pour qu'une classe profite d'une autre, il suffira, apès l'habituel <code>class Nomclass</code> de mettre le mot clé <em>extends</em> suivi du nom de la classe sur laquelle on veut s'appuyer. Par exemple: <code>class Magicien extends Personnage</code>. Cette façon de faire permet de dire que l'on veut que notre nouvelle classe profite de notre classe Personnage.</p>
