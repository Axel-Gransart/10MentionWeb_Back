    ...
    <main class="container-fluid px-5">
        <div class="row d-md-flex justify-content-around my-3">
          <div class="col-sm-12 col-md-8 border my-3 border-primary">
            ...
            <p>La boucle est, comme en JS, une boucle qui permet d'executer un code TANT QUE la condition d'entrée est toujours remplie.</p>
            <?php
          ...
          <div class="col-sm-12 col-md-8 border my-3 border-primary">
            ...
            <p>La boucle FOR, comme toute les boucles, sert à répeter un morceau de code tant que la condition n'est pas respectée. Sa structure est cependant différente :</p>
            <ol>
          ...
          <div class="col-sm-12 col-md-8 border my-3 border-primary">
            ...
            <p>La boucle FOR EACH sert à parcourir un tableau ( array() ou [] ). On verra cette boucle plus en détails dans la page dédiée aux array(). </p>
