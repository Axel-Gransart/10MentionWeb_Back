...
<header class="p-5 m-4 bg-light rounded-3 border ">
  <section class="container-fluid py-5">
    <?php
      echo "<h1 class='display-5 text-center fw-bold'>Les importations de fichiers avec require() et include()</h1>"; // une instruction d'affichage en PHP
...
<main class="container-fluid px-5">
  <div class="row">
    ...
    <div class="col-sm-12 mt-5">
      ...
      <div class="row">
        <div class="col-sm-12 col-md-6">
          ...
          <p>On va créer un dossier inc à la racine de notre dossier php</p>
          <p>Dans ce dossier inc on va créer un fichier test1.inc.php</p>
          <p>On crée une balise p avec une phrase : Ceci est le premier fichier d'inclusion</p><br>
          <pre> include "inc/test1.inc.php";</pre>
          <?php
            /**
        ...
        <div class="col-sm-12 col-md-6">
          ...
          <p>Dans ce dossier inc on vas créer un fichier test2.inc.php</p>
          <p>On crée une balise p avec une phrase : Ceci est le deuxième fichier d'inclusion</p>
          <pre> include_once "inc/test2.inc.php";</pre>
          <?php
            /**
    ...
    <div class="col-sm-12 mt-5">
      ...
      <div class="row">
        <div class="col-sm-12 col-md-6">
          ...
          <p>On va créer un dossier inc à la racine de notre dossier php</p>
          <p>Dans ce dossier inc on va créer un fichier test3.inc.php</p>
          <p>On crée une balise p avec une phrase : Ceci est le premier fichier d'inclusion</p>
          <pre> require "inc/test3.inc.php";</pre>
          <?php
            /**
             * On va créer un dossier inc à la racine de notre dossier php
             * Dans ce dossier inc on va créer un fichier test3.inc.php
             * On crée une balise p avec une phrase : Ceci est le premier fichier d'inclusion
             */
        ...
        <div class="col-sm-12 col-md-6">
          ...
          <p>Dans ce dossier inc on va créer un fichier test4.inc.php</p>
          <p>On crée une balise p avec une phrase : Ceci est le deuxième fichier d'inclusion</p>
          <pre> require_once "inc/test4.inc.php";</pre>
          <?php
            /**
             * Dans ce dossier inc on va créer un fichier test4.inc.php
             * On crée une balise p avec une phrase : Ceci est le deuxième fichier d'inclusion
             */
    ...
    <div class="col-sm-12 mb-5">
      ...
      <p class="alert alert-warning text-center fw-bold">l'utilisation des fonctions include_once et require_once est dépréciée
    ...
    <div class="col-sm-12 mb-5">
      <h2 class="text-center border-top pt-5 mb-5">La différence entre include() et require()</h2>
